...
class AppController extends Controller
{
    ...
    /**
     * Добавить в систему админа, если его нет. В качестве параметра метод принимает email суперпользователя; при вызове метода без парметра админ будет создан с почтой decilya@gmail.com
     * Пример вызова: php yii app/add-admin test@test.com
     *
    ...
    public function actionAddAdmin($email =  null)
    {
        ...
        if (empty($model)) {
            ...
            $user->description = 'Суперпользователь системы';
